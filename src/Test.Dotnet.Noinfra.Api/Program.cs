...
using Test.Dotnet.Noinfra.Api.AutoMapper;
using Test.Dotnet.Noinfra.Api.Config;
using Test.Dotnet.Noinfra.Api.Extensions;
using Test.Dotnet.Noinfra.Api.HealthChecks;
...
namespace Test.Dotnet.Noinfra.Api;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Test.Dotnet.Noinfra", Version = "v1" });
        });
